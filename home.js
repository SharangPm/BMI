...
if (bmi < 18.5) {
    result2.innerHTML += ` 
        ...
        <div class="col-7">
            <h1 style="color:gold ;font-size:70px">You are Under Weight</h1>
    ...
    result2.innerHTML += `<div class="col-5">
        ...
        <div class="col-7">
            <h1 style="color:gold ;font-size:70px">You are Normal Weight</h1>
    ...
    <div class="col-5">
        ...
        <div class="col-7">
            <h1 style="color:gold ;font-size:70px">You are Over Weight</h1>
    ...
    <div class="col-5">
        ...
        <div class="col-7">
            <h1 style="color:gold ;font-size:70px">You are Obese</h1>
    ...
    result2.innerHTML += `
        ...
        <div class="col-7">
            <h1 style="color:gold ;font-size:70px">You are Extremely Obese</h1>
